	...
	,tryId: function(ids,cur) {
		...
		if(cur < ids.length) {
			...
			this.peers = new roi_js_Peers(this.key).create(id,function(_) {
				haxe_Log.trace(" -> got this one #" + id + " c:",{ fileName : "Main.hx", lineNumber : 64, className : "Main", methodName : "tryId"});
				_g.peers.addCommand("say",function(t) {
					haxe_Log.trace(" -> #" + t.id + " said " + t.text,{ fileName : "Main.hx", lineNumber : 65, className : "Main", methodName : "tryId"});
				});
		...
		} else haxe_Log.trace(" -> no free id :c",{ fileName : "Main.hx", lineNumber : 98, className : "Main", methodName : "tryId"});
	}
	,onkeydown: function(event) {
		var _g1 = this;
		...
		case 50:
			...
			break;
		default:
			haxe_Log.trace("no act for this key",{ fileName : "Main.hx", lineNumber : 117, className : "Main", methodName : "onkeydown"});
		}
	}
	,onkeyup: function(e) {
